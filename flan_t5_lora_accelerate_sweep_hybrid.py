...
def parse_args():
    ...
    parser.add_argument("--yaml_path", default="./yaml_files/config_flan_t5_base_lora_sweep_hybrid.yaml",type=str, help="The path where the yaml config file exists", required=False)
