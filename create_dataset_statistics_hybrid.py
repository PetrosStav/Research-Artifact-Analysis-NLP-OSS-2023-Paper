...
with open('./data/raa_hybrid_dataset_aug_transformed_train.json', 'r') as f:
    train_data = json.load(f)

with open('./data/raa_hybrid_dataset_aug_transformed_dev.json', 'r') as f:
    dev_data = json.load(f)

with open('./data/raa_hybrid_dataset_aug_transformed_test.json', 'r') as f:
...
with open('./data/raa_hybrid_dataset.json', 'r') as f:
    og_data = json.load(f)

for d in og_data:
    d['Type'] = type_mapping[d['Type']]

with open('./data/raa_hybrid_dataset_unique_snippets_train.txt', 'r') as f:
    og_train_snippets = f.read().splitlines()

og_train_snippets_lower = [s.lower() for s in og_train_snippets]

with open('./data/raa_hybrid_dataset_unique_snippets_dev.txt', 'r') as f:
    og_dev_snippets = f.read().splitlines()

og_dev_snippets_lower = [s.lower() for s in og_dev_snippets]

with open('./data/raa_hybrid_dataset_unique_snippets_test.txt', 'r') as f:
...
with open('./material/hybrid_dataset_stats.json', 'w') as f:
    json.dump({
...
df.to_excel('./material/hybrid_dataset_og_stats_snippets.xlsx')
...
# Save DataFrame to Excel
df.to_excel('./material/hybrid_dataset_og_stats_qa_pairs.xlsx')
...
# Save DataFrame to Excel
df.to_excel('./material/hybrid_dataset_aug_stats_snippets.xlsx')
...
# Save DataFrame to Excel
df.to_excel('./material/hybrid_dataset_aug_stats_qa_pairs.xlsx')
